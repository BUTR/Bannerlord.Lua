...
{
    internal class WrappedSubModuleLuaType : Type
    {
        private readonly Type _typeImplementation = typeof(SubModuleLua);

        private readonly string _moduleFolder;
        private readonly string _scriptName;
        private readonly string _subModuleClassType;

        public WrappedSubModuleLuaType(string moduleFolder, string scriptName, string subModuleClassType)
        {
